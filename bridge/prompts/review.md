...
reMarkable tablet was tagged `#review`. Its extracted text is provided as your input.
...
- Output **Markdown only** — it is rendered directly to a PDF placed on the tablet.
  ...
  e-ink screen.
- If the extracted text is **empty, garbled, or too ambiguous to review meaningfully**,
  do NOT guess. Begin your response with the exact marker `needs-clarification` on the
  first line, then briefly explain what is unclear and what you would need.
